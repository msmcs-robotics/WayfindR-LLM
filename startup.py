...
def main():
    ...
    print("  Robot Diagnostics: http://localhost:5000/diagnostics/{robot_id}")
    print("")
    print("  OPERATOR (Dashboard):")
    print("    Chat:            POST /chat")
    print("")
    print("  ROBOT (Android App):")
    print("    Chat:            POST /robot_chat  {robot_id, message}")
    print("    Telemetry:       POST /telemetry   {robot_id, telemetry}")
    print("    Map State:       GET  /map/state/{robot_id}")
    print("")
    print("  MONITORING:")
    print("    Health:          GET  /health")
    print("    All Robots:      GET  /robots")
    print("    Robot Details:   GET  /robots/{robot_id}")
    print("")
    print("  MAP & ZONES:")
    print("    Floors:          GET  /map/floors")
    print("    Waypoints:       GET  /map/waypoints")
    print("    Zones:           GET  /map/zones")
    print("    Blocked Zones:   GET  /map/zones/blocked")
    print("    Create Zone:     POST /map/zones")
    print("=" * 60 + "\n")
